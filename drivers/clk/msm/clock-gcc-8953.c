...
static struct clk_freq_tbl ftbl_gfx3d_clk_src[] = {
	...
	F_MM( 100000000, FIXED_CLK_SRC,  gpll0_main_div2_mm,    3,    0,     0),
	F_MM( 160000000, FIXED_CLK_SRC,  gpll0_main_div2_mm,  2.5,    0,     0),
	F_MM( 200000000, FIXED_CLK_SRC,  gpll0_main_div2_mm,    2,    0,     0),
	F_MM( 256000000, FIXED_CLK_SRC, gpll6_main_div2_gfx,  2.5,    0,     0),
	F_MM( 266670000, FIXED_CLK_SRC,               gpll0,    3,    0,     0),
	F_MM( 381000000, FIXED_CLK_SRC,               gpll0,  2.5,    0,     0),
	F_MM( 400000000, FIXED_CLK_SRC,               gpll0,    2,    0,     0),
	F_MM( 535000000, FIXED_CLK_SRC,       gpll4_out_aux,  2.5,    0,     0),
	F_MM( 683000000,    1240000000,               gpll3,    1,    0,     0),
	F_MM( 875000000,    1360000000,               gpll3,    1,    0,     0),
	F_MM( 1076000000,   1480000000,               gpll3,    1,    0,     0),
	F_MM( 1232000000,   1553000000,               gpll3,    1,    0,     0),
	F_MM( 1464000000,   1553000000,               gpll3,    1,    0,     0),
...
static struct clk_freq_tbl ftbl_blsp_i2c_apps_clk_src[] = {
	F(  30000000,              xo,    1,    0,     0),
	F(  50000000, gpll0_main_div2,   16,    0,     0),
...
static struct rcg_clk blsp1_qup1_i2c_apps_clk_src = {
	...
	.c = {
		...
		.ops = &clk_ops_rcg,
		VDD_DIG_FMAX_MAP2(LOW_SVS, 50000000, SVS, 70000000),
...
static struct rcg_clk blsp1_qup1_spi_apps_clk_src = {
	...
	.c = {
		...
		.ops = &clk_ops_rcg_mnd,
		VDD_DIG_FMAX_MAP3(LOW_SVS, 30000000, SVS, 50000000, NOM,
				70000000),
