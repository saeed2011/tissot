...
static struct clk_freq_tbl ftbl_gfx3d_clk_src[] = {
	...
	F_MM( 650000000,    1250000000,               gpll3,    1,    0,     0),
	F_MM( 800000000,    1370000000,               gpll3,    1,    0,     0),
	F_MM( 950000000,    1480000000,               gpll3,    1,    0,     0),
	F_MM( 1100000000,   1490000000,               gpll3,    1,    0,     0),
	F_MM( 1250000000,   1530000000,               gpll3,    1,    0,     0),
...
static struct clk_freq_tbl ftbl_blsp_i2c_apps_clk_src[] = {
	F(  19200000,              xo,    1,    0,     0),
	F(  35000000, gpll0_main_div2,   16,    0,     0),
...
static struct rcg_clk blsp1_qup1_i2c_apps_clk_src = {
	...
	.c = {
		...
		.ops = &clk_ops_rcg,
		VDD_DIG_FMAX_MAP2(LOW_SVS, 35000000, SVS, 70000000),
...
static struct rcg_clk blsp1_qup1_spi_apps_clk_src = {
	...
	.c = {
		...
		.ops = &clk_ops_rcg_mnd,
		VDD_DIG_FMAX_MAP3(LOW_SVS, 12500000, SVS, 35000000, NOM,
				70000000),
